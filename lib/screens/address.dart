...
class _AddressState extends State<Address> {
    ...
    if (_shippingAddressList.length > 0) {
      ...
      _shippingAddressList.forEach((address) {
        ...
        _selected_country_list_for_update
            .add(Country(id: address.country_id, name: address.country_name, code: '2', status: 0, ));
        _selected_state_list_for_update
            .add(MyState(id: address.state_id, name: address.state_name, country_id: 10));
        _selected_city_list_for_update
            .add(City(id: address.city_id, name: address.city_name, state_id: 1 ));
      });
  ...
  onSelectCountryDuringAdd(country, setModalState) {
    ...
    _selected_state = country;
    _selected_city = country;
    setState(() {});
  ...
  onSelectCountryDuringUpdate(index, country, setModalState) {
    ...
    _selected_state_list_for_update[index] = country;
